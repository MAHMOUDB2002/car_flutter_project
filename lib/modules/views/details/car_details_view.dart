...
import 'package:car_project/modules/controllers/car_details_controller.dart';
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            CustomText(
                                              text:
                                                  "\$${controller.carDetailsl?.data!.price}",
                                                ...
                                                children: [
                                                  RatingBar.builder(
                                                    initialRating: double.parse(
                                                            "${controller.carDetailsl?.data?.stars}") ??
                                                        2,
                                                  ...
                                                  CustomText(
                                                    text:
                                                        "${controller.carDetailsl?.data!.ratingsCount}",
                                                    style: Theme.of(context)
                                                        .textTheme
                                                        .bodyText1
                                                        ?.copyWith(
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                              CachedNetworkImage(
                                                                imageUrl:
                                                                    '${controller.carDetailsl?.data!.brand!.logo}',
                                                                placeholder:
                                                                    (context,
                                                                            url) =>
                                                                        SizedBox(
                                                              ...
                                                              CustomText(
                                                                text:
                                                                    "${controller.carDetailsl?.data!.enginePower

                                                                    // controller.carDetailsl?.data!.enginePower?[index]
                                                              ...
                                                              CustomText(
                                                                text:
                                                                    "${controller.carDetailsl?.data!.maxTorque}",
                                                                style: Theme.of(
                                                                        context)
                                                                    .textTheme
                                                                    .bodyText1
                                                ...
                                                if (controller.index == 0)
                                                  Column(
                                                    ...
                                                    children: [
                                                      ...
                                                      //           CachedNetworkImage(
                                                      //             imageUrl:
                                                      //                 '${controller.carDetailsl?.data?.image}',
                                                      //             placeholder:
                                                      //                 (context,
                                                      //                         url) =>
                                                      //                     SizedBox(
