...
class CarDetailsController extends GetxController {
          ...
          Container(
            ...
            decoration: BoxDecoration(
                ...
                color: Theme.of(context)
                    .colorScheme
                    .copyWith(
                        primary: AppColor.secondryColorText.withOpacity(0.3))
                    .primary),
            child: Column(
  ...
  Widget bulidSecondItemList(context, index) => Container(
        width: 100.w,
        decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(10.r), color: AppColor.White
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              CustomText(
                text: "${allCarModel?.data?[index].name}",
                //"${item[index].carInfo}",
                style: Theme.of(context).textTheme.bodyText1?.copyWith(
                      color: Colors.black,
  ...
  getAllcarData() {
    DioHelper.get_data(url: CARS).then((value) async {
      //if (value.statusCode == 200) {
        ...
        child: Padding(
          ...
          child: ListTile(
            ...
            title: Row(
              children: [
                ...
                Padding(
                  ...
                  child: CustomText(
                    text: "\$${allCarModel?.data?[index].price}",
                    style: Theme.of(context).textTheme.bodyText1?.copyWith(
                          fontSize: 14.sp,
                          color: Theme.of(context).colorScheme.primaryVariant,
                          fontWeight: FontWeight.w700,
            ...
            subtitle: Row(
              children: [
                CustomText(
                  text: "${allCarModel?.data?[index].acceleration}",
                  style: Theme.of(context).textTheme.bodyText1?.copyWith(
                        fontSize: 10.sp,
                        fontWeight: FontWeight.w400,
                      ),
  ...
  Widget buildCars(context, index) => Padding(
        padding: EdgeInsets.only(top: 10.h),
        child: Column(
          children: [
            CachedNetworkImage(
              imageUrl: '${allCarModel?.data?[index].image}',
